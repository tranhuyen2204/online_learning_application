<%-- 
    Document   : BusinessStrategyAndManagement
    Created on : Mar 9, 2025, 8:41:53 PM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <title>Business Strategy And Management</title>
        <style>
            /* menu */
            body {
                margin: 0;
...
.popup {
    ...
    <body>
        ...
        <section class="hero">
            <img src="${pageContext.request.contextPath}/img/courses/11.jpg">
        </section>
        <section id="about" class="content">
            <h2>Introduction to Business Strategy And Management</h2>
