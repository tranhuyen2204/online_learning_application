<%-- 
    Document   : GraphicDesignWithAdobePhotoshop
    Created on : Mar 9, 2025, 8:46:25 PM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <title>Graphic Design With Adobe Photoshop</title>
        <style>
/* menu */            
        body {
            margin: 0;
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/13.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to Graphic Design With Adobe Photoshop</h2>
