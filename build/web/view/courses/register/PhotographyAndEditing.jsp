<%-- 
    Document   : PhotographyAndEditing
    Created on : Mar 9, 2025, 8:49:38 PM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <title>Photography And Editing</title>
        <style>
/* menu */            
        body {
            margin: 0;
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/15.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to Photography And Editing</h2>
