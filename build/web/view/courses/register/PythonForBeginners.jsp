<%-- 
    Document   : PythonForBeginners
    Created on : Mar 9, 2025, 4:39:04 PM
    Author     : ADMIN
--%>
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/1.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to Python for Beginners</h2>
