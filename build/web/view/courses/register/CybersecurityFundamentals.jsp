<%-- 
    Document   : CybersecurityFundamentals
    Created on : Mar 9, 2025, 8:35:15 PM
    Author     : ADMIN
--%>
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/7.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to Cybersecurity Fundamentals</h2>
