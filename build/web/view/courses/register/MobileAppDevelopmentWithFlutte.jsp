<%-- 
    Document   : MobileAppDevelopmentWithFlutte
    Created on : Mar 9, 2025, 8:36:57 PM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <title>Mobile App Development With Flutte</title>
        <style>
/* menu */            
        body {
            margin: 0;
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/8.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to Mobile App Development With Flutte</h2>
