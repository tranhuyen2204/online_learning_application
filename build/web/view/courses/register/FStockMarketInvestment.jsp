<%-- 
    Document   : FStockMarketInvestment
    Created on : Mar 9, 2025, 8:43:44 PM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <title>FStock Market Investment</title>
        <style>
/* menu */            
        body {
            margin: 0;
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/12.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to FStock Market Investment</h2>
