<%-- 
    Document   : FullStackWebDevelopment
    Created on : Mar 9, 2025, 8:17:06 PM
    Author     : ADMIN
--%>
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/5.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to Full - Stack Web Development</h2>
