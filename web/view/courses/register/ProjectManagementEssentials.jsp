<%-- 
    Document   : ProjectManagementEssentials
    Created on : Mar 9, 2025, 8:51:46 PM
    Author     : ADMIN
--%>
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/17.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to Project Management Essentials</h2>
