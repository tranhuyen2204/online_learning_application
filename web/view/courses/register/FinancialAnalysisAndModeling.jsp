<%-- 
    Document   : FinancialAnalysisAndModeling
    Created on : Mar 9, 2025, 8:38:48 PM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <title>Financial Analysis And Modeling</title>
        <style>
/* menu */            
        body {
            margin: 0;
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/9.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to Financial Analysis And Modeling</h2>
