<%-- 
    Document   : JavaScriptEssentials
    Created on : Mar 9, 2025, 8:13:02 PM
    Author     : ADMIN
--%>
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/3.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to JavaScript Essentials</h2>
