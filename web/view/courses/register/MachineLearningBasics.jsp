<%-- 
    Document   : MachineLearningBasics
    Created on : Mar 9, 2025, 8:19:08 PM
    Author     : ADMIN
--%>
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/6.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to Machine Learning Basics</h2>
