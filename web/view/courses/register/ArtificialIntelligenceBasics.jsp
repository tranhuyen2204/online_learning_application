<%-- 
    Document   : ArtificialIntelligenceBasics
    Created on : Mar 9, 2025, 8:54:42 PM
    Author     : ADMIN
--%>
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/19.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to Artificial Intelligence Basics</h2>
