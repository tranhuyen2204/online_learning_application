<%-- 
    Document   : DigitalMarketingMastery
    Created on : Mar 9, 2025, 8:40:28 PM
    Author     : ADMIN
--%>
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/10.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to Digital Marketing Mastery</h2>
