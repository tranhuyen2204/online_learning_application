<%-- 
    Document   : UiUxDesignEssentials
    Created on : Mar 9, 2025, 8:47:59 PM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <title>UI/UX Design Essentials</title>
        <style>
/* menu */            
        body {
            margin: 0;
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/14.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to UI/UX Design Essentials</h2>
