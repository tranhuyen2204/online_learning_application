<%-- 
    Document   : ReactjsAdvanced
    Created on : Mar 9, 2025, 8:15:19 PM
    Author     : ADMIN
--%>
...
.popup {
    ...
    <section class="hero">
        <img src="${pageContext.request.contextPath}/img/courses/4.jpg">
    </section>
    <section id="about" class="content">
        <h2>Introduction to ReactJS Advanced</h2>
